...
savename='/big_scr7/dryan/pztelmc/pztel_hyper_reproc1'
...
def logl(theta,eps,xy,sig):
    ...
    XY=koe(eps,q,tau,argp,lan,inc,ecc,mass,para)
...
def logp(theta): #FOR 51 eri
    ...
    if (logq < np.log(0.001) or logq > np.log(500)): 
        return -np.inf
...
if __name__=='__main__':
    ...
    sampler=PTSampler(ntemps, nwalkers, ndim, logl, logp ,loglargs=[eps,xy,sigs],threads=64)
